namespace :db do
  ...
  task populate: :environment do
    ...
    user1.letters.create!(content:"Today through Sunday, March 22nd, get a Large Cheese Pizza for just $5.99 when you carryout.", title:"Deal from Papa John's")
    user1.letters.create!(content:" Welcome to Job Seeker Premium!  Over the next few weeks, we'll be sending you emails to show you all the great features you get with Job Seeker Premium, share our favorite job search tips, and help you track your progress.  To get started, learn how to:", title:"Welcome to Job Seeker Premium")
    user1.letters.build(content:"You're invited BusyBusyLabs has started using Slack. The administrator, logan, has invited you to join.", title:"Jimbo has invited you to join BusybusyLabs on Slack")

    user1.letters.create!(content: "THE THURSDAY BRIEF - MARCH 12, 2015 CUNY Photo Challenge 
